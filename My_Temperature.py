...
def getSensorsTemperature(access_token,groupId):
	...
	response = requests.get(baseUrl+sensorsTemperatureUrl,params=parameters,json=requestBody)

	responseCodes(response)
	return response.json()['sensors']

#Saving Result only as a dictionary
Result = getSensorsTemperature(access_token,groupId)[0]

#Display of Temperature
print("Current Temperature = ",Result['ambientTemperature']/1000, " °C")
